...
public class App {
	...
	public void addGroup() {
		...
		attributes.put(attribute);
		// user details
		attributes.put("cn", "NitroDX");
		// this could be the group owner as the initial member
		attributes.put("uniqueMember","cn=Tommy");
		try {
			connection.createSubcontext("cn=NitroDX,ou=groups,ou=system", attributes);
	...
	public static void main(String[] args) throws NamingException {
		...
		// app.searchUsers();
		app.addGroup();
		// app.addUserToGroup("Tommy", "NitroDX");
